	...
	<div class="container-login100" style="background-image: url('images/opp.jpg');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form">
				<span data-animation="fadeInUp" data-delay="200ms" class="login100-form-title p-b-37">Error 404
				</span>
				...
				<div class="container-login100-form-btn">
					...
					<a style="color: white;" href="dashboard/./logout" class="login100-form-btn">
						Go Back
					</a>
